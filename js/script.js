document.addEventListener("DOMContentLoaded", function() {
    ...
    const App = {
        ...
        startContentAnimation: function() {
            ...
            tl.from('#hero-title-svg', { y: 100, opacity: 0, duration: 0.8, ease: 'power3.out' });
            tl.from('#hero-subtitle-svg', { y: 50, opacity: 0, duration: 0.8, ease: 'power3.out' }, "-=0.6");
            tl.from('.scroll-arrow', { y: 30, opacity: 0, duration: 1, ease: 'power3.out' }, "-=0.5");
        },
        ...
        initScrollAnimations: function() {
            gsap.utils.toArray('.project-section').forEach(section => {
                ...
                const description = section.querySelector('.project-description-wrapper');
                ...
                if (isReversed) {
                    tl.from(media, { xPercent: 100, opacity: 0, duration: 0.8, ease: 'power3.out' })
                      .from(description, { xPercent: -100, opacity: 0, duration: 0.8, ease: 'power3.out' }, "-=0.6");
                } else {
                    tl.from(media, { xPercent: -100, opacity: 0, duration: 0.8, ease: 'power3.out' })
                      .from(description, { xPercent: 100, opacity: 0, duration: 0.8, ease: 'power3.out' }, "-=0.6");
                }
        ...
        initEmailClipboard: function() {
            ...
            emailLink.addEventListener('click', function(event) {
                ...
                navigator.clipboard.writeText(emailAddress).then(() => {
                    ...
                    gsap.to(tooltip, { opacity: 1, y: 0, duration: 0.3, ease: 'power3.out' });
                    gsap.to(tooltip, {
                        opacity: 0, y: -10, duration: 0.3, ease: 'power3.in', delay: 1.5,
